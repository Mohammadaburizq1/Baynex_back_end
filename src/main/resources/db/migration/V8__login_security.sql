...
ALTER TABLE app_users ADD COLUMN IF NOT EXISTS last_failed_login_at TIMESTAMPTZ;
ALTER TABLE app_users ADD COLUMN IF NOT EXISTS last_successful_login_at TIMESTAMPTZ;
